...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://mongolian-survey.herokuapp.com',
...
var surveyEvents = __webpack_require__(15);
var answerEvents = __webpack_require__(37);
...
var onIndexSurvey = function onIndexSurvey() {
  event.preventDefault();
  api.indexSurvey().then(ui.indexSurveySuccess).catch(ui.indexSurveyFailure);
};

var onShowSurvey = function onShowSurvey(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.showSurvey(data.survey.id).then(ui.showSurveySuccess).catch(ui.showSurveyFailure);
};
var onDeleteSurvey = function onDeleteSurvey(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  if (confirm('Are you sure you want to delete this survey')) {
    api.deleteSurvey(data.survey.id).then(ui.deleteSurveySuccess).catch(ui.deleteSurveyFailure);
  }
};
var onUpdateSurvey = function onUpdateSurvey(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.updateSurvey(data).then(ui.updateSurveySuccess).catch(ui.updateSurveyFailure);
  // console.log('working')
};
...
var onUserSurveys = function onUserSurveys() {
  event.preventDefault();
  api.indexSurvey().then(ui.userSurveysSuccess).catch(ui);
};
...
var indexSurvey = function indexSurvey(data) {
  return $.ajax({
    url: config.apiUrl + '/surveys',
    method: 'GET',
    headers: {
...
var showSurvey = function showSurvey(data) {
  return $.ajax({
...
var showSurveyTemplate = __webpack_require__(35);
var showUserSurveysTemplate = __webpack_require__(36);
var store = __webpack_require__(2);

var createSurveySuccess = function createSurveySuccess() {
...
var createSurveyFailure = function createSurveyFailure(data) {
...
var indexSurveySuccess = function indexSurveySuccess(data) {
  var getSurveyHtml = showSurveysTemplate({
...
var userSurveysSuccess = function userSurveysSuccess(data) {
  $('.handlebars').empty();
  $('.content').removeClass('hidden');
  // $('.content').empty()
  ...
  userSurveys.forEach(function (survey) {
    var getUserSurveyHtml = showUserSurveysTemplate({
      survey: survey
    });
...
var indexSurveyFailure = function indexSurveyFailure(data) {
...
var showSurveySuccess = function showSurveySuccess(data) {
  ...
  var getSurveyHtml = showSurveyTemplate({
    survey: data.survey
  });
  $('.content').removeClass('hidden');
...
var showSurveyFailure = function showSurveyFailure(data) {
...
var updateSurveyFailure = function updateSurveyFailure(data) {
...
module.exports = {
  ...
  indexSurveyFailure: indexSurveyFailure,
  indexSurveySuccess: indexSurveySuccess,
  showSurveySuccess: showSurveySuccess,
  showSurveyFailure: showSurveyFailure,
  ...
  userSurveysSuccess: userSurveysSuccess
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "<div class=\"handlebars\">\n<h3 data-id=\""
    ...
    + "</p>\n\n    <p><strong> -   Survey ID:</strong> "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "</p>\n\n\n  <button type=\"button\" class=\"btn btn-default\" data-toggle=\"modal\" data-target=\"#"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\">Take this survey!</button>\n\n  <div class=\"modal answer-modal fade\" id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"myModalLabel\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    ...
    + "\n            </h2>\n            <form class=\"create-answer\">\n                  <!-- <input type=\"radio\" class='radio-btn' name=\"answer[response]\" value=\"1\" required>1 Strongly Disagree\n                  <input type=\"radio\" class='radio-btn'name=\"answer[response]\" value=\"2\">2 Disagree\n                  <input type=\"radio\" class='radio-btn'name=\"answer[response]\" value=\"3\">3 Neutral\n                  <input type=\"radio\" class='radio-btn'name=\"answer[response]\" value=\"4\">4 Agree<\n                  <input type=\"radio\" class='radio-btn'name=\"answer[response]\" value=\"5\">5 Strongly Agree<br> -->\n                  <input type=\"text\" name=\"answer[survey]\" placeholder=\"survey id\" class=\"hidden\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\"><br>\n\n                  <div class=\"btn-group\" data-toggle=\"buttons\">\n                    <label class=\"btn btn-default\">\n                      <input type=\"radio\" name=\"answer[response]\" value=\"1\" autocomplete=\"off\" required> Strongly Disagree\n                    </label>\n                    <label class=\"btn btn-default\">\n                      <input type=\"radio\" name=\"answer[response]\" value=\"2\" autocomplete=\"off\"> Disagree\n                    </label>\n                    <label class=\"btn btn-default\">\n                      <input type=\"radio\" name=\"answer[response]\" value=\"3\" autocomplete=\"off\"> Neutral\n                    </label>\n                    <label class=\"btn btn-default\">\n                      <input type=\"radio\" name=\"answer[response]\" value=\"4\" autocomplete=\"off\"> Agree\n                    </label>\n                    <label class=\"btn btn-default\">\n                      <input type=\"radio\" name=\"answer[response]\" value=\"5\" autocomplete=\"off\"> Strongly Agree\n                    </label>\n                  </div>\n                  <br>\n                  <input type=\"submit\" class='submit-answer-button btn btn-default' data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "\" value=\"Submit Answer\">\n            </form>\n\n            <form data-id='"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1._id : stack1), depth0))
    + "' class=\"index-answer hidden\">\n              <fieldset>\n                <input type=\"submit\" class=\"btn btn-default\" value=\"View Results\">\n              </fieldset>\n            </form>\n\n            <div class=\"results\"></div>\n          </div>\n\n          <div class=\"modal-footer\">\n              <p class=\"modal-message\"></p>\n            <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n          </div>\n        </div>\n      </div>\n    </div>\n\n</div>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"handlebars\">\n<h1 data-id=\""
    ...
    + "</small></h1>\n  <p><strong>Description: </strong> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1.description : stack1), depth0))
...
module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "  <div class=\"handlebars\">\n  <h1 data-id=\""
    ...
    + "\n    </p>\n    <p><strong>Survey ID:</strong> "
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1._id : stack1), depth0))
    + "\n    </p>\n\n    <form class=\"delete-survey survey-forms\">\n      <fieldset>\n        <input type=\"text\" class=\"hidden \"name=\"survey[id]\" value=\""
    + alias2(alias1(((stack1 = (depth0 != null ? depth0.survey : depth0)) != null ? stack1._id : stack1), depth0))
    + "\" required>\n        <input type=\"submit\" class=\"btn btn-default\" value=\"Delete This Survey\">\n      </fieldset>\n    </form>\n\n  </div>\n";
},"useData":true});
...
var onCreateAnswer = function onCreateAnswer(event) {
  ...
  api.createAnswer(data).then(ui.createAnswerSuccess).catch(ui.createAnswerFailure);
  // console.log('working')
};
...
// }
var onIndexAnswer = function onIndexAnswer(event) {
  event.preventDefault();
  var surveyId = $(event.target).data('id');

  api.indexAnswer().then(function (data) {
...
var createAnswer = function createAnswer(data) {
  return $.ajax({
...
var indexAnswer = function indexAnswer(data) {
  return $.ajax({
    url: config.apiUrl + '/answers',
    method: 'GET',
    headers: {
...
var createAnswerFailure = function createAnswerFailure(data) {
...
var indexAnswerSuccess = function indexAnswerSuccess(data, surveyId) {
...
var indexAnswerFailure = function indexAnswerFailure(data, surveyId) {
...
module.exports = {
  createAnswerFailure: createAnswerFailure,
  createAnswerSuccess: createAnswerSuccess,
  // showAnswerSuccess,
  // showAnswerFailure,
  indexAnswerSuccess: indexAnswerSuccess,
  indexAnswerFailure: indexAnswerFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = __webpack_require__.p + "0f09e7e21d2339913096541dc0123d22.jpg";
